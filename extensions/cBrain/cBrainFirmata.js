...
const SYSEX_RESPONSE = {
  ...
  [I2C_REPLY](board) {
    ...
    //console.log('already decode by firmata', reply);
...
class Firmata extends Emitter {
  ...
  VservoWrite(pin, pulse, speed) {
    if (typeof pin === "undefined") {
      throw new Error("servoWrite: pin must be specified");
    }

    if (typeof pulse === "undefined") {
      throw new Error("servoWrite: degree must be specified");
    }
